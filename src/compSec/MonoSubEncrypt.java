...
public class MonoSubEncrypt {
	...
	public static void main(String[] args) {
			...
			char monoSub[]=new char[26];
			int monoSub_number=0;
			for(int i=0;i<=25;i++)
			{
				monoSub_number= (3*i)%26;
				monoSub[i]=getLetter(monoSub_number);	
			}
			System.out.println("\nMono-Alphabetic Substitution Table:");
			for(int i=0;i<=25;i++)
				System.out.print(monoSub[i]);
